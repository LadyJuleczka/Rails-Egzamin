...
class LandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create land" do
    assert_difference('Land.count') do
      post lands_url, params: { land: { idl: @land.idl, ldesc: @land.ldesc, lname: @land.lname } }
    end
  ...
  test "should update land" do
    patch land_url(@land), params: { land: { idl: @land.idl, ldesc: @land.ldesc, lname: @land.lname } }
